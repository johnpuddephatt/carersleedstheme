        ...
        <div class="flex-1 overflow-auto">
          ...
          <div x-show="results">
            ...
            <template x-for="result in results"><a
                x-show="['post', 'page', 'tribe_events'].includes(result.post_type) && ((result.post_type !== 'tribe_events') || (!result.permalink.includes('__trashed') && new Date(result._EventStartDate) > new Date()))"
