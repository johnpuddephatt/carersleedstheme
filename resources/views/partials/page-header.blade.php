@if (isset($post))
  <div class="overflow-hidden">
    ...
    @if (has_post_thumbnail($post->ID))
      <div class="relative -mb-16 ml-auto w-2/3 max-w-4xl pb-8 md:-mb-24 md:w-1/2">
    ...
    @endif
    <div class="{{ !has_post_thumbnail($post->ID) ? 'pt-24' : '' }} container xl:max-w-5xl 2xl:max-w-6xl">
      <div class="relative">
